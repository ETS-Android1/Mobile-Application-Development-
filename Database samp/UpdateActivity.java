        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!id.getText().toString().matches("[A-Za-z0-9]+") || !c.moveToNext()) {
                    ...
                    msg = "Updated!";
                    db.execSQL("UPDATE EMPLOYEES SET NAME = ?, SALARY = ?,  GENDER = ? WHERE ID = ?;", new String[]{name.getText().toString(), salary.getText().toString(), sel.getText().toString(), id.getText().toString()});
                }
